...
def guard_args(name: str, args: dict, *, profile_root: Path, external: bool) -> None:
    ...
    if external and name == "db_import_csv" and str(args.get("if_exists") or "append") != "append":
        raise PermissionError("external_write permits append-only CSV imports")
