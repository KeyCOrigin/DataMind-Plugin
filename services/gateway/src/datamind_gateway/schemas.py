...
GATEWAY_TOOLS = [
    ...
    {"name": "datamind_agent_store", "description": "Ask DataMind StoreAgent.", "inputSchema": {"type": "object", "properties": {"message": {"type": "string"}, "confirm": {"type": "boolean"}, "_context": {"type": "object"}}, "required": ["message", "confirm"]}},
    {"name": "datamind_agent_store_external", "description": "Store a validated external batch through StoreAgent.", "inputSchema": {"type": "object", "properties": {"batch": {"type": "object"}, "confirm": {"type": "boolean"}, "_context": {"type": "object"}}, "required": ["batch", "confirm"]}},
