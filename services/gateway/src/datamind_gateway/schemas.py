...
GATEWAY_TOOLS = [
    ...
    {"name": "datamind_agent_store_batch", "description": "Process multiple independent items in one StoreAgent session and return one receipt set per item.", "inputSchema": {"type": "object", "properties": {"items": {"type": "array", "minItems": 1, "maxItems": 500, "items": {"type": "object", "properties": {"source": {"type": "string"}, "text": {"type": "string"}, "kind": {"type": "string", "enum": ["text", "table"]}, "external_id": {"type": "string"}, "metadata": {"type": "object"}}, "required": ["source"]}}, "confirm": {"type": "boolean"}, "source_trust": {"type": "string", "enum": ["internal", "external"], "default": "internal"}, "_context": {"type": "object"}}, "required": ["items", "confirm"]}},
