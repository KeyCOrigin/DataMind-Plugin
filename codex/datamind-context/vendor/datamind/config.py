...
class Settings(BaseSettings):
    ...
    def data_dir(self) -> str:
        ...
        if self.data_dir_override:
            return os.path.abspath(os.path.expanduser(self.data_dir_override))
    ...
    def storage_dir(self) -> str:
        ...
        if self.storage_dir_override:
            return os.path.abspath(os.path.expanduser(self.storage_dir_override))
    ...
    def skills_dir(self) -> str:
        ...
        if self.skills_dir_override:
            return os.path.abspath(os.path.expanduser(self.skills_dir_override))
